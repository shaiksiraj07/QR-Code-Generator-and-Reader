...
btn1 = Button(frame1, text="Generate", bg='grey', fg='gold', font=('ariel 15 bold'), relief=GROOVE, command=generate)
btn1.place(x=85, y=425)
btn2 = Button(frame1, text="Exit", width=10, bg='grey', fg='gold', font=('ariel 15 bold'), relief=GROOVE, command=root.destroy)
btn2.place(x=255, y=425)
btn2 = Button(frame2, text="Select Image", bg='grey', fg='gold', font=('ariel 15 bold'), relief=GROOVE, command=selected)
btn2.pack(side=LEFT, padx=50, pady=5)
btn3 = Button(frame2, text="Exit", width=12, bg='grey', fg='gold', font=('ariel 15 bold'), relief=GROOVE, command=root.destroy)
